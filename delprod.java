...
public class delprod extends JFrame {
    ...
    JPanel panel,panel2;
    JLabel id,title,name,pid,quan,exp,title1;
    JTextField p_id;
    ...
    ActionListener submitListener = new ActionListener(){
        public void actionPerformed(ActionEvent e) {
            if(p_id.getText().isEmpty()){
                JOptionPane.showMessageDialog(null,"Provide Product ID");
            }
            else {
                panel2 = new JPanel();
                add(panel2);
                panel2.setLayout(null);
                panel2.setBounds(450, 310, 550, 350);
                ...
                exp.setBounds(50,230,300,20);
                exp.setForeground(Color.black);

                delete = new JButton("DELETE");
                panel2.add(delete);
                delete.setBounds(235, 300, 83, 20);
