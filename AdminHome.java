...
public class AdminHome extends JFrame {
    JButton addCashier,deleteCashier,addProduct,deleteProduct,updateProduct,updateCashier,analysis;
    JLabel addc,dltc,addp,dltp,uptp,header,updtc,analy;
    JPanel cont;
    ...
    AdminHome()
    {
        ...
        cont.setBounds(160,200,1250,400);
        cont.setLayout(null);
        ...
        header.setBounds(430,50,900,45);
        ...
        analysis.setIcon(new ImageIcon(new ImageIcon("D:\\javaproject\\Main_System\\Billing_System\\src\\main\\bms\\analysis.png").getImage().getScaledInstance(70,70, Image.SCALE_SMOOTH)));
        analysis.setBounds(1070,150,100,80);
        analy = new JLabel();
        analy.setText("Sales Analysis");
        analy.setForeground(new Color(238,241,239));
        analy.setFont(new Font("Consolas",Font.PLAIN,15));
        labelSize = analy.getPreferredSize();
        labelX = (analysis.getWidth() - labelSize.width) / 2 + analysis.getX();
        labelY = analysis.getY() + analysis.getHeight() + 5; //
        analy.setBounds(labelX, labelY, labelSize.width, labelSize.height);
        ...
        ActionListener updpr = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
        ...
        ActionListener dltprd = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                new delprod().setVisible(true);
            }
        };

        ActionListener analy = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                new analysisinterface().setVisible(true);
            }
        };
        ...
        updateProduct.addActionListener(updpr);
        deleteProduct.addActionListener(dltprd);
        analysis.addActionListener(analy);
    }
}